...
Button uploadimagebtn,submitorderbtn;
...
List<Note> noted;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
     ...
     //  name=root.findViewById(R.id.editText_name);
       Button btn=root.findViewById(R.id.changeAddbtn);
    ...
    uploadimagebtn=root.findViewById(R.id.button);
    submitorderbtn=root.findViewById(R.id.button2);
   ...
   ArrayList<String> urlImage=new ArrayList<>();
    ...
    void upload(){
        ...
        hashMap.put("description",directorderDescription_edittext.getText().toString());
    ...
    public  void  upload_to_node(String reference){
        ...
        try{
            data2.put("address_id",noted.get(MyItemRecyclerViewAdapter.lastCheckedPosition).getAddress_id());
        ...
        final JsonObjectRequest putRequest = new JsonObjectRequest(Request.Method.POST
                , "http://ec2-3-16-216-35.us-east-2.compute.amazonaws.com:3000/post-direct-order", data2,
